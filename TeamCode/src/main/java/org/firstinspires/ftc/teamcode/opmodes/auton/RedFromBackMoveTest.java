...
public class RedFromBackMoveTest extends RedShootFromBack {
    ...
    protected Command createCommand() {
        return commandFactory.startMove(startPosition, preloadShootingPosition)
                ...
                .andThen(commandFactory.moveTo(getRowStartingPosition(RowsOnFloor.FIRST), .7))
//                .andThen(commandFactory.sleep(1000))
...
//                .andThen(commandFactory.sleep(1000))
                ...
                .andThen(commandFactory.sleep(1000))
                .andThen(commandFactory.moveTo(getRowStartingPosition(RowsOnFloor.SECOND), .8))
//                .andThen(commandFactory.sleep(1000))
                .andThen(commandFactory.moveTo(getRowEndingPosition(RowsOnFloor.SECOND), .3))
//                .andThen(commandFactory.sleep(1000))
                .andThen(commandFactory.moveTo(rowShootingPosition, .8))
                .andThen(commandFactory.sleep(1000))
                .andThen(commandFactory.moveTo(getRowStartingPosition(RowsOnFloor.THIRD), .8))
//                .andThen(commandFactory.sleep(1000))
