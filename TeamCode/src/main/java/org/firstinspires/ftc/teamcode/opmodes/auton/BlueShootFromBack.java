...
public class BlueShootFromBack extends AutonBase {
    ...
    public static double preloadShootingAngle = 122.5;
    public static double rowShootingAngle = 115;
    ...
    public static Pose rowShootingPosition = new Pose(54, 15, Math.toRadians(rowShootingAngle));//new Pose(86, 11, Math.toRadians(shootingAngle));
