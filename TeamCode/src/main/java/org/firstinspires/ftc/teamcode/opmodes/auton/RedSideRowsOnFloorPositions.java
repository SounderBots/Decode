...
public class RedSideRowsOnFloorPositions {
    ...
    public static Pose firstRowStartingPosition = new Pose(36, 32.16, Math.toRadians(180));
    public static Pose secondRowStartingPosition = new Pose(36, 56.16, Math.toRadians(180));
    public static Pose thirdRowStartingPosition = new Pose(36, 80.16, Math.toRadians(180));
