...
public class RedSideRowsOnFloorPositions {
    ...
    public static Pose secondRowStartingPosition = new Pose(46, 56.16, Math.toRadians(180));
    public static Pose thirdRowStartingPosition = new Pose(46, 80.16, Math.toRadians(180));
